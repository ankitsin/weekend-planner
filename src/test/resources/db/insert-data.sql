...
insert into user (user_id,email_id,name,mobile,token_id) values (2,'vikas@practo.com','Vikas Bhoria','8960032462',null);
...
insert into trip (trip_id,trip_name,user_id,going_date,destination_id,going_people,space_left,num_of_day,average_cost,created_at,modified_at,is_deleted) values (2,'Trip to Muthyala Maduvu',2,now(),1,3,20,3,5000,now(),now(),0);
