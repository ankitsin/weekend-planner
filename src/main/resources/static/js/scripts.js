        ...
        e(".price-slider").each(function() {
            ...
            a.slider({
                ...
                slide: function(t, i) {
                    ...
                    a.siblings(".price_slider_amount").find(".from").text("Rs" + n[0]), a.siblings(".price_slider_amount").find(".to").text("Rs" + n[1])
                }
            });
            var t = a.slider("option", "values");
            a.siblings(".price_slider_amount").find(".from").text("Rs" + t[0]), a.siblings(".price_slider_amount").find(".to").text("Rs" + t[1])
        })
    }
